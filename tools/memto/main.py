...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/Users/xiefang09/xiefang/python/time_series-20230328/time_series/data/experiment_data/processed/SMD')
    parser.add_argument('--model_save_path', type=str, default='/Users/xiefang09/xiefang/python/time_series-20230328/time_series/tools/memto/checkpoints')
    ...
    parser.add_argument('--phase_type', type=str, default='second_train', help='whether it requires memory item embeddings. False: using random initialization, True: using customized intialization')

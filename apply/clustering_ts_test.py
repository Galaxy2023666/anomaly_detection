...
if __name__ == '__main__':
    ...
    cluster_index_count_file = '/Users/xiefang09/xiefang/python/time_series-20230328/time_series/data/anomaly/cluster_index_count.csv'
    anomaly_file = '/Users/xiefang09/xiefang/python/time_series-20230328/time_series/data/anomaly/result_mbr2023-12.csv'
    data_file = '/Users/xiefang09/xiefang/python/time_series-20230328/time_series/data/anomaly/baseline_202401.csv'
    ...
    if not os.path.exists(data_file) or is_update:
        ...
        cluster_result = cluster.predict(data_long, dim_cols, 'value', True, length,
                                         '/Users/xiefang09/xiefang/python/time_series-20230328/time_series/data/anomaly/cluster.png')
    ...
    df_babp['year_mo'] = '2024_01'  # 这一行每个月需要更改一下
    ...
    df_babp.to_csv('/Users/xiefang09/xiefang/python/time_series-20230328/time_series/data/anomaly/202401BABP-V4.csv',

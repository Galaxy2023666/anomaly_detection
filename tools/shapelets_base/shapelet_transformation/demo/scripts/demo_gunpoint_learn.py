...
from tools.shaplets_base.shapelet_transformation.src.preprocessing_anomaly import preprocessing_anomaly
from tools.shaplets_base.shapelet_transformation.src.SVDD.SVDD import SVDD
from tools.shaplets_base.shapelet_transformation.src.util import Scaler, euclidean_distance_shifted, length_normalized_distance, max_corr, get_weights_via_kmeans
from tools.shaplets_base.shapelet_transformation.src.learning.learningextractor import LearningShapelets
from tools.shaplets_base.shapelet_transformation.src.learning.similarityloss import DiscrepancySimilarity
from tools.shaplets_base.shapelet_transformation.src.searching.bruteforce_multivariate import Bruteforce_extractor_mv, Candidateset
from tools.shaplets_base.shapelet_transformation.src.searching.RLS import RLS_extractor, RLS_candidateset
...
data_name = "GunPoint"
X_train = np.load(f'/Users/xiefang09/xiefang/python/time_series-20230328/time_series/tools/shaplets_base/shapelet_transformation/demo/data/{data_name}_train.npy')
y_train = np.load(f'/Users/xiefang09/xiefang/python/time_series-20230328/time_series/tools/shaplets_base/shapelet_transformation/demo/data/{data_name}_train_labels.npy')
X_test = np.load(f'/Users/xiefang09/xiefang/python/time_series-20230328/time_series/tools/shaplets_base/shapelet_transformation/demo/data/{data_name}_test.npy')
y_test = np.load(f'/Users/xiefang09/xiefang/python/time_series-20230328/time_series/tools/shaplets_base/shapelet_transformation/demo/data/{data_name}_test_labeles.npy')
